...
- Latest governance/settlement bugfix closeout verification kept `./gradlew compileJava` green, and the targeted settlement/governance test slice remained green after the helper overload fix in `BannerModSettlementService.summarizeStockpiles(...)`.
