...
- War Room and political UI now cover political entity list/detail actions, siege-standard placement, siege-zone HUD status, government form toggles, cooldown-backed war spam protection, and a synced battle-window phase banner with humanized open/close countdown.
