...
import com.talhanation.recruits.entities.AbstractRecruitEntity.TargetSearchProfilingSnapshot;
import com.talhanation.recruits.pathfinding.GlobalPathfindingController;
import com.talhanation.recruits.pathfinding.AsyncPathProcessor.ProfilingSnapshot;
...
public final class RecruitsBattleGameTestSupport {
    ...
    public static void prepareSameDestinationMovement(List<? extends AbstractRecruitEntity> recruits, BlockPos targetPos) {
        for (AbstractRecruitEntity recruit : recruits) {
    ...
    public static BattleProfilingSnapshot captureProfilingSnapshot(GameTestHelper helper, String scenarioId, int warmupTicks) {
        return new BattleProfilingSnapshot(
                ...
                com.talhanation.recruits.pathfinding.AsyncPathProcessor.profilingSnapshot(),
    ...
    public static String formatProfilingSnapshot(BattleProfilingSnapshot snapshot) {
        return "scenario=" + snapshot.scenarioId()
                ...
                + ", searchOpportunities=" + snapshot.targetSearch().searchOpportunities()
                ...
                + ", lodSkippedSearches=" + snapshot.targetSearch().lodSkippedSearches()
                + ", lodFullTierTicks=" + snapshot.targetSearch().lodFullTierTicks()
                + ", lodReducedTierTicks=" + snapshot.targetSearch().lodReducedTierTicks()
                + ", lodShedTierTicks=" + snapshot.targetSearch().lodShedTierTicks()
                ...
                + ", droppedPathCallbacks=" + snapshot.pathfinding().droppedCallbacks()
                ...
                + ", controllerFlowFieldEligible=" + snapshot.controller().flowFieldEligibleRequests()
                + ", controllerFlowFieldAttempts=" + snapshot.controller().flowFieldPrototypeAttempts()
                + ", controllerFlowFieldHits=" + snapshot.controller().flowFieldPrototypeHits()
                + ", controllerFlowFieldFallbacks=" + snapshot.controller().flowFieldPrototypeFallbacks()
                + ", controllerBudgetPerTick=" + snapshot.controller().requestBudgetPerTick()
                + ", controllerBudgetUsedThisTick=" + snapshot.controller().budgetUsedThisTick()
                + ", controllerDeferredRequests=" + snapshot.controller().deferredRequests()
                + ", controllerDeferredResumes=" + snapshot.controller().deferredResumes()
                + ", controllerDeferredDrops=" + snapshot.controller().deferredDrops()
                + ", controllerDeferredDropsBacklogCap=" + snapshot.controller().deferredDropsBacklogCap()
                + ", controllerDeferredDropsMaxAge=" + snapshot.controller().deferredDropsMaxAge()
                + ", controllerDeferredDropsInvalidated=" + snapshot.controller().deferredDropsInvalidated()
                + ", controllerCurrentDeferredQueueDepth=" + snapshot.controller().currentDeferredQueueDepth()
                + ", controllerMaxDeferredQueueDepth=" + snapshot.controller().maxDeferredQueueDepth()
                + ", controllerTotalDeferredLatencyTicks=" + snapshot.controller().totalDeferredLatencyTicks()
                + ", controllerMaxDeferredLatencyTicks=" + snapshot.controller().maxDeferredLatencyTicks()
