...
public class RecruitsToastManager {
    private static final ResourceLocation LETTER_IMAGE = ResourceLocation.fromNamespaceAndPath(BannerModMain.MOD_ID, "textures/gui/image/letter.png");
    private static final ResourceLocation ALLY_IMAGE = ResourceLocation.fromNamespaceAndPath(BannerModMain.MOD_ID, "textures/gui/image/ally.png");
    private static final ResourceLocation ENEMY_IMAGE = ResourceLocation.fromNamespaceAndPath(BannerModMain.MOD_ID, "textures/gui/image/enemy.png");
    private static final ResourceLocation NEUTRAL_IMAGE = ResourceLocation.fromNamespaceAndPath(BannerModMain.MOD_ID, "textures/gui/image/neutral.png");
    private static final ResourceLocation CROWN_IMAGE = ResourceLocation.fromNamespaceAndPath(BannerModMain.MOD_ID, "textures/gui/image/leader_crown.png");
