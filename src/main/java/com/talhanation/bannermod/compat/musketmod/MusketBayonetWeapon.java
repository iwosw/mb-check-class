...
public class MusketBayonetWeapon extends AbstractMusketWeapon {

    @Override
    protected Field getWeaponField() { return MusketModReflection.musketWithBayonetField; }
    ...
    @Override
    protected float getBulletAccuracy() { return 3F; }
