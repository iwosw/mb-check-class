...
import com.talhanation.bannerlord.client.civilian.gui.MerchantAddEditTradeScreen;
import com.talhanation.bannerlord.client.civilian.gui.MerchantTradeScreen;
...
public class ModMenuTypes {
    ...
    public static final DeferredRegister<MenuType<?>> MENU_TYPES =
            DeferredRegister.create(ForgeRegistries.MENU_TYPES, WorkersRuntime.modId());
