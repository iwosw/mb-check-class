...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, WorkersRuntime.modId());
    public static final RegistryObject<Block> COURIER_BLOCK = BLOCKS.register("courier_block",
