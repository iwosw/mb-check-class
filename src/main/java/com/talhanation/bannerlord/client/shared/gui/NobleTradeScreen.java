...
import com.talhanation.bannerlord.client.shared.gui.component.RecruitsMultiLineEditBox;
...
import static com.talhanation.bannerlord.client.shared.ClientManager.currency;
...
public class NobleTradeScreen extends RecruitsScreenBase {
    ...
    private static final Component TITLE = Component.translatable("gui.bannermod.villager_noble");
    private static final Component HIRE_BUTTON = Component.translatable("gui.bannermod.villager_noble.hire");
    private static final Component TEXT_VILLAGERS = Component.translatable("gui.bannermod.villager_noble.villagers");
    private static final Component INVENTORY_BUTTON = Component.translatable("gui.bannermod.inv.openInventory");
    private static final Component ERROR_NOT_ENOUGH_VILLAGERS = Component.translatable("gui.bannermod.villager_noble.error_no_villagers");
    private static final Component ERROR_NO_USES = Component.translatable("gui.bannermod.villager_noble.error_no_uses");
    private static final Component ERROR_NOT_ENOUGH_CURRENCY = Component.translatable("gui.bannermod.villager_noble.error_not_enough_currency");
    private static final Component ERROR_HIRE_LIMIT_REACHED = Component.translatable("gui.bannermod.villager_noble.error_hire_limit_reached");
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (groupSelectionDropDownMenu != null) {
            groupSelectionDropDownMenu.renderWidget(guiGraphics, mouseX, mouseY, partialTick);
        }
    }
