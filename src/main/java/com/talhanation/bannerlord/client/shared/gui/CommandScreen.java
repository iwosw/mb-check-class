...
import com.talhanation.bannerlord.client.shared.events.ClientEvent;
...
import com.talhanation.bannerlord.client.shared.gui.group.*;
...
public class CommandScreen extends ScreenBase<CommandMenu> {
    ...
    private static final MutableComponent TEXT_EVERYONE = Component.translatable("gui.bannermod.command.text.everyone");
    ...
    private static MutableComponent TEXT_ATTACK(String group_string) {
        return Component.translatable("chat.bannermod.command.attack", group_string);
    }

    private static MutableComponent TEXT_WANDER(String group_string) {
        return Component.translatable("chat.bannermod.command.wander", group_string);
    }

    private static MutableComponent TEXT_FOLLOW(String group_string) {
        return Component.translatable("chat.bannermod.command.follow", group_string);
    }

    private static MutableComponent TEXT_HOLD_POS(String group_string) {
        return Component.translatable("chat.bannermod.command.holdPos", group_string);
    }

    private static MutableComponent TEXT_BACK_TO_POS(String group_string) {
        return Component.translatable("chat.bannermod.command.backToPos", group_string);
    }

    private static MutableComponent TEXT_BACK_TO_MOUNT(String group_string) {
        return Component.translatable("chat.bannermod.command.backToMount", group_string);
    }

    private static MutableComponent TEXT_REST(String group_string) {
        return Component.translatable("chat.bannermod.command.rest", group_string);
    }
    private static MutableComponent TEXT_HOLD_MY_POS(String group_string) {
        return Component.translatable("chat.bannermod.command.holdMyPos", group_string);
    }

    private static MutableComponent TEXT_PROTECT(String group_string) {
        return Component.translatable("chat.bannermod.command.protect", group_string);
    }

    private static MutableComponent TEXT_UPKEEP(String group_string) {
        return Component.translatable("chat.bannermod.command.upkeep", group_string);
    }
    private static MutableComponent TEXT_CLEAR_UPKEEP(String group_string) {
        return Component.translatable("chat.bannermod.command.clear_upkeep", group_string);
    }
    private static MutableComponent TEXT_SHIELDS_OFF(String group_string) {
        return Component.translatable("chat.bannermod.command.shields_off", group_string);
    }

    private static MutableComponent TEXT_STRATEGIC_FIRE_OFF(String group_string) {
        return Component.translatable("chat.bannermod.command.strategic_fire_off", group_string);
    }

    private static MutableComponent TEXT_SHIELDS(String group_string) {
        return Component.translatable("chat.bannermod.command.shields", group_string);
    }

    private static MutableComponent TEXT_STRATEGIC_FIRE(String group_string) {
        return Component.translatable("chat.bannermod.command.strategic_fire", group_string);
    }

    private static MutableComponent TEXT_MOVE(String group_string) {
        return Component.translatable("chat.bannermod.command.move", group_string);
    }

    private static MutableComponent TEXT_FORWARD(String group_string) {
        return Component.translatable("chat.bannermod.command.forward", group_string);
    }
    private static MutableComponent TEXT_BACKWARD(String group_string) {
        return Component.translatable("chat.bannermod.command.backward", group_string);
    }

    private static MutableComponent TEXT_CLEAR_TARGETS(String group_string) {
        return Component.translatable("chat.bannermod.command.clearTargets", group_string);
    }
    private static MutableComponent TEXT_DISMOUNT(String group_string) {
        return Component.translatable("chat.bannermod.command.dismount", group_string);
    }

    private static MutableComponent TEXT_MOUNT(String group_string) {
        return Component.translatable("chat.bannermod.command.mount", group_string);
    }

    private static MutableComponent TEXT_PASSIVE(String group_string) {
        return Component.translatable("chat.bannermod.command.passive", group_string);
    }

    private static MutableComponent TEXT_RAID(String group_string) {
        return Component.translatable("chat.bannermod.command.raid", group_string);
    }

    private static MutableComponent TEXT_AGGRESSIVE(String group_string) {
        return Component.translatable("chat.bannermod.command.aggressive", group_string);
    }

    private static MutableComponent TEXT_NEUTRAL(String group_string) {
        return Component.translatable("chat.bannermod.command.neutral", group_string);
    }
    ...
    private static MutableComponent TEXT_FIRE_AT_WILL(String group_string) {
        return Component.translatable("chat.bannermod.command.fire_at_will", group_string);
    }

    private static MutableComponent TEXT_HOLD_FIRE(String group_string) {
        return Component.translatable("chat.bannermod.command.hold_fire", group_string);
    }

    private static MutableComponent TEXT_FACE(String group_string) {
        return Component.translatable("chat.bannermod.command.face", group_string);
    }

    private static MutableComponent TEXT_SELECT_ALL_GROUPS() {
        return Component.translatable("gui.bannermod.command.tip.de_select_groups");
    }
    private static MutableComponent TEXT_SCROLL_CATEGORIES() {
        return Component.translatable("gui.bannermod.command.tip.scrollCategories");
    }
