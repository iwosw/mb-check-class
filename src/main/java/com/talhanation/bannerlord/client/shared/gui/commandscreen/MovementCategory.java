...
import com.talhanation.bannerlord.client.shared.gui.group.RecruitsFormationButton;
...
public class MovementCategory implements ICommandCategory {
    ...
    private static final MutableComponent TEXT_MOVE = Component.translatable("gui.bannermod.command.text.move");
    private static final MutableComponent TEXT_MOVE_HOLD = Component.translatable("gui.bannermod.command.text.move_hold");
    private static final MutableComponent TEXT_FORWARD = Component.translatable("gui.bannermod.command.text.forward");
    private static final MutableComponent TEXT_BACKWARD = Component.translatable("gui.bannermod.command.text.backward");
    private static final MutableComponent TEXT_FOLLOW = Component.translatable("gui.bannermod.command.text.follow");
    private static final MutableComponent TEXT_WANDER = Component.translatable("gui.bannermod.command.text.wander");
    private static final MutableComponent TEXT_HOLD_POS = Component.translatable("gui.bannermod.command.text.holdPos");
    private static final MutableComponent TEXT_BACK_TO_POS = Component.translatable("gui.bannermod.command.text.backToPos");
    private static final MutableComponent TEXT_FACE = Component.translatable("gui.bannermod.command.text.face");
    private static final MutableComponent TEXT_TIGHT = Component.translatable("gui.bannermod.command.text.tight");
    private static final MutableComponent TEXT_FORMATION_LINEUP = Component.translatable("gui.bannermod.command.text.formation_lineup");
    private static final MutableComponent TEXT_FORMATION_SQUARE = Component.translatable("gui.bannermod.command.text.formation_square");
    private static final MutableComponent TEXT_FORMATION_TRIANGLE = Component.translatable("gui.bannermod.command.text.formation_triangle");
    private static final MutableComponent TEXT_FORMATION_HOLLOW_SQUARE = Component.translatable("gui.bannermod.command.text.formation_hollow_square");
    private static final MutableComponent TEXT_FORMATION_HOLLOW_CIRCLE = Component.translatable("gui.bannermod.command.text.formation_hollow_circle");
    private static final MutableComponent TEXT_FORMATION_V = Component.translatable("gui.bannermod.command.text.formation_v");
    private static final MutableComponent TEXT_FORMATION_CIRCLE = Component.translatable("gui.bannermod.command.text.formation_circle");
    private static final MutableComponent TEXT_FORMATION_MOVEMENT = Component.translatable("gui.bannermod.command.text.formation_movement");
    private static final MutableComponent TEXT_FORMATION_NONE = Component.translatable("gui.bannermod.command.text.formation_none");
    private static final MutableComponent TEXT_HOLD_MY_POS = Component.translatable("gui.bannermod.command.text.holdMyPos");
    private static final MutableComponent TOOLTIP_MOVE = Component.translatable("gui.bannermod.command.tooltip.move_hold");
    private static final MutableComponent TOOLTIP_FORWARD = Component.translatable("gui.bannermod.command.tooltip.forward");
    private static final MutableComponent TOOLTIP_FORMATION = Component.translatable("gui.bannermod.command.tooltip.formation");
    private static final MutableComponent TOOLTIP_BACKWARD = Component.translatable("gui.bannermod.command.tooltip.backward");
    private static final MutableComponent TOOLTIP_FOLLOW = Component.translatable("gui.bannermod.command.tooltip.follow");
    private static final MutableComponent TOOLTIP_WANDER = Component.translatable("gui.bannermod.command.tooltip.wander");
    private static final MutableComponent TOOLTIP_HOLD_MY_POS = Component.translatable("gui.bannermod.command.tooltip.holdMyPos");
    private static final MutableComponent TOOLTIP_HOLD_POS = Component.translatable("gui.bannermod.command.tooltip.holdPos");
    private static final MutableComponent TOOLTIP_BACK_TO_POS = Component.translatable("gui.bannermod.command.tooltip.backToPos");
    private static final MutableComponent TOOLTIP_MOVEMENT = Component.translatable("gui.bannermod.command.tooltip.movement");
    private static final MutableComponent TOOLTIP_FACE = Component.translatable("gui.bannermod.command.tooltip.face");
    private static final MutableComponent TOOLTIP_TIGHT = Component.translatable("gui.bannermod.command.tooltip.tight");
