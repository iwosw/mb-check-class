...
import com.talhanation.bannerlord.client.shared.gui.diplomacy.DiplomacyEditScreen;
...
public class WorldMapContextMenu {
    ...
    private static final Component TEXT_DIPLOMACY          = Component.translatable("gui.bannermod.map.diplomacy");
    private static final Component TEXT_CLAIM_CHUNK        = Component.translatable("gui.bannermod.map.claim_chunk");
    private static final Component TEXT_CLAIM_AREA         = Component.translatable("gui.bannermod.map.claim_area");
    private static final Component TEXT_EDIT_CLAIM         = Component.translatable("gui.bannermod.map.edit_claim");
    private static final Component TEXT_REMOVE_CHUNK       = Component.translatable("gui.bannermod.map.remove_chunk");
    private static final Component TEXT_CENTER_MAP         = Component.translatable("gui.bannermod.map.center_map");
    private static final Component TEXT_REMOVE_CHUNK_ADMIN = Component.translatable("gui.bannermod.map.remove_chunk_admin");
    private static final Component TEXT_DELETE_CLAIM_ADMIN = Component.translatable("gui.bannermod.map.delete_claim_admin");
    private static final Component TEXT_TELEPORT_ADMIN     = Component.translatable("gui.bannermod.map.teleport_admin");
