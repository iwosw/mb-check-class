...
import com.talhanation.bannerlord.client.shared.gui.widgets.ScrollDropDownMenu;
...
public class RecruitInventoryScreen extends ScreenBase<RecruitInventoryMenu> {
    ...
    private static final MutableComponent TEXT_HEALTH = Component.translatable("gui.bannermod.inv.health");
    private static final MutableComponent TEXT_LEVEL = Component.translatable("gui.bannermod.inv.level");
    private static final MutableComponent TEXT_KILLS = Component.translatable("gui.bannermod.inv.kills");
    private static final MutableComponent TEXT_DISBAND = Component.translatable("gui.bannermod.inv.text.disband");
    private static final MutableComponent TEXT_INFO_FOLLOW = Component.translatable("gui.bannermod.inv.info.text.follow");
    private static final MutableComponent TEXT_INFO_WANDER = Component.translatable("gui.bannermod.inv.info.text.wander");
    private static final MutableComponent TEXT_INFO_HOLD_POS = Component.translatable("gui.bannermod.inv.info.text.hold_pos");
    private static final MutableComponent TEXT_INFO_PASSIVE = Component.translatable("gui.bannermod.inv.info.text.passive");
    private static final MutableComponent TEXT_INFO_NEUTRAL = Component.translatable("gui.bannermod.inv.info.text.neutral");
    private static final MutableComponent TEXT_INFO_AGGRESSIVE = Component.translatable("gui.bannermod.inv.info.text.aggressive");
    private static final MutableComponent TEXT_INFO_LISTEN = Component.translatable("gui.bannermod.inv.info.text.listen");
    private static final MutableComponent TEXT_INFO_IGNORE = Component.translatable("gui.bannermod.inv.info.text.ignore");
    private static final MutableComponent TEXT_INFO_RAID = Component.translatable("gui.bannermod.inv.info.text.raid");
    private static final MutableComponent TEXT_INFO_PROTECT = Component.translatable("gui.bannermod.inv.info.text.protect");
    private static final MutableComponent TEXT_INFO_WORKING = Component.translatable("gui.bannermod.inv.info.text.working");
    private static final MutableComponent TEXT_DISMOUNT = Component.translatable("gui.bannermod.inv.text.dismount");
    private static final MutableComponent TEXT_BACK_TO_MOUNT = Component.translatable("gui.bannermod.inv.text.backToMount");
    private static final MutableComponent TOOLTIP_DISMOUNT = Component.translatable("gui.bannermod.inv.tooltip.dismount");
    private static final MutableComponent TOOLTIP_FOLLOW = Component.translatable("gui.bannermod.inv.tooltip.follow");
    private static final MutableComponent TOOLTIP_WANDER = Component.translatable("gui.bannermod.inv.tooltip.wander");
    private static final MutableComponent TOOLTIP_HOLD_MY_POS = Component.translatable("gui.bannermod.inv.tooltip.holdMyPos");
    private static final MutableComponent TOOLTIP_HOLD_POS = Component.translatable("gui.bannermod.inv.tooltip.holdPos");
    private static final MutableComponent TOOLTIP_BACK_TO_POS = Component.translatable("gui.bannermod.inv.tooltip.backToPos");
    private static final MutableComponent TOOLTIP_CLEAR_TARGET = Component.translatable("gui.bannermod.inv.tooltip.clearTargets");
    private static final MutableComponent TOOLTIP_MOUNT = Component.translatable("gui.bannermod.inv.tooltip.mount");
    private static final MutableComponent TOOLTIP_PASSIVE = Component.translatable("gui.bannermod.inv.tooltip.passive");
    private static final MutableComponent TOOLTIP_NEUTRAL = Component.translatable("gui.bannermod.inv.tooltip.neutral");
    private static final MutableComponent TOOLTIP_AGGRESSIVE = Component.translatable("gui.bannermod.inv.tooltip.aggressive");
    private static final MutableComponent TOOLTIP_RAID = Component.translatable("gui.bannermod.inv.tooltip.raid");
    private static final MutableComponent TOOLTIP_BACK_TO_MOUNT = Component.translatable("gui.bannermod.inv.tooltip.backToMount");
    private static final MutableComponent TOOLTIP_CLEAR_UPKEEP = Component.translatable("gui.bannermod.inv.tooltip.clearUpkeep");
    private static final MutableComponent TEXT_FOLLOW = Component.translatable("gui.bannermod.inv.text.follow");
    private static final MutableComponent TEXT_WANDER = Component.translatable("gui.bannermod.inv.text.wander");
    private static final MutableComponent TEXT_HOLD_MY_POS = Component.translatable("gui.bannermod.inv.text.holdMyPos");
    private static final MutableComponent TEXT_HOLD_POS = Component.translatable("gui.bannermod.inv.text.holdPos");
    private static final MutableComponent TEXT_BACK_TO_POS = Component.translatable("gui.bannermod.inv.text.backToPos");
    private static final MutableComponent TEXT_PASSIVE = Component.translatable("gui.bannermod.inv.text.passive");
    private static final MutableComponent TEXT_NEUTRAL = Component.translatable("gui.bannermod.inv.text.neutral");
    private static final MutableComponent TEXT_AGGRESSIVE = Component.translatable("gui.bannermod.inv.text.aggressive");
    private static final MutableComponent TEXT_RAID = Component.translatable("gui.bannermod.inv.text.raid");
    private static final MutableComponent TEXT_CLEAR_TARGET = Component.translatable("gui.bannermod.inv.text.clearTargets");
    private static final MutableComponent TEXT_MOUNT = Component.translatable("gui.bannermod.command.text.mount");
    private static final MutableComponent TEXT_CLEAR_UPKEEP = Component.translatable("gui.bannermod.inv.text.clearUpkeep");

    private static final MutableComponent TEXT_PROMOTE = Component.translatable("gui.bannermod.inv.text.promote");
    private static final MutableComponent TEXT_SPECIAL = Component.translatable("gui.bannermod.inv.text.special");
    private static final MutableComponent TOOLTIP_PROMOTE = Component.translatable("gui.bannermod.inv.tooltip.promote");
    private static final MutableComponent TOOLTIP_DISABLED_PROMOTE = Component.translatable("gui.bannermod.inv.tooltip.promote_disabled");
    private static final MutableComponent TOOLTIP_SPECIAL = Component.translatable("gui.bannermod.inv.tooltip.special");
