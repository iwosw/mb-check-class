...
import com.talhanation.bannerlord.client.shared.gui.widgets.SelectedFactionWidget;
...
public class MessengerTreatyAnswerScreen extends RecruitsScreenBase {
    ...
    private static final Component TITLE        = Component.translatable("gui.bannermod.messenger.treaty_title");
    private static final Component BUTTON_ACCEPT  = Component.translatable("gui.bannermod.messenger.accept_treaty");
    private static final Component BUTTON_DECLINE  = Component.translatable("gui.bannermod.messenger.decline_treaty");
    private static final Component TEXT_FACTION = Component.translatable("gui.bannermod.messenger.text_faction");
    private static final Component TEXT_DURATION = Component.translatable("gui.bannermod.messenger.text_duration");
    private static final Component DESCRIPTION_TEXT = Component.translatable("description.bannermod.peaceTreaty");
