...
import com.talhanation.bannerlord.client.shared.gui.widgets.ListScreenEntryBase;
...
public class RecruitsFactionEntry extends ListScreenEntryBase<RecruitsFactionEntry> {
    ...
    private Component getPlayersText(int players){
        if(team.maxPlayers > 0){
            return Component.translatable("gui.bannermod.team_list.players_count", players, team.maxPlayers);
        }
        else
            return  Component.translatable("gui.bannermod.team_list.players_no_count", players);
