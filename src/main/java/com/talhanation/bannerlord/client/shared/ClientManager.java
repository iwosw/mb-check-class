...
public class ClientManager {
    ...
    public static void resetSynchronizedState() {
        com.talhanation.recruits.migration.StatePersistenceSeams.ClientSyncState resetState = SYNCHRONIZED_STATE.resetPreservingRoutes(routesMap);
