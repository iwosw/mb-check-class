...
import com.talhanation.bannerlord.client.civilian.gui.widgets.ItemScrollDropDownMenu;
...
public class LumberAreaScreen extends WorkAreaScreen {
    ...
    private static final MutableComponent TEXT_SHEAR_LEAVES = Component.translatable("gui.bannermod.workers.checkbox.shearLeaves");
    private static final MutableComponent TEXT_STRIP_LOGS = Component.translatable("gui.bannermod.workers.checkbox.stripLogs");
    private static final MutableComponent TEXT_REPLANT = Component.translatable("gui.bannermod.workers.checkbox.replant");
    private static final MutableComponent TEXT_ANY_SAPLING = Component.translatable("gui.bannermod.workers.command.text.anySapling");
    ...
    public void setButtons() {
        ...
        this.shearLeavesCheckBox = new RecruitsCheckBox(checkBoxX, 50 + checkBoxY, checkBoxWidth, checkBoxHeight, TEXT_SHEAR_LEAVES,
            ...
            (bool) -> {
                ...
                WorkersRuntime.channel().sendToServer(new MessageUpdateLumberArea(lumberArea.getUUID(), currentSapling, shearLeaves, stripLogs, replant));
            }
        );
