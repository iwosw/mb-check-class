...
import com.talhanation.bannerlord.ai.civilian.MerchantWorkGoal;
...
public class MerchantEntity extends AbstractWorkerEntity {
    ...
    public void openTradeGUI(Player player) {
        ...
        if (player instanceof ServerPlayer sp) {
            ...
            WorkersRuntime.channel().sendToServer(new MessageOpenMerchantTradeScreen(player, this.getUUID()));
        }
    }
    ...
    public void openAddEditTradeGUI(Player player, WorkersMerchantTrade trade) {
        if (player instanceof ServerPlayer sp) {
            ...
            WorkersRuntime.channel().sendToServer(new MessageOpenMerchantEditTradeScreen(player, this.getUUID(), trade));
        }
    }
    ...
    public Component TEXT_NO_ITEM_LEFT(String s){
        return Component.translatable("chat.bannermod.workers.text.merchantNoItemsLeft", this.getName().getString(), s);
    }

    public Component TEXT_NO_ITEM_LEFT_OWNER(String s){
        return Component.translatable("chat.bannermod.workers.text.merchantNoItemsLeftOwner", this.getName().getString(), s);
    }

    public Component TEXT_LIMIT_REACHED_OWNER(String currency, String goods){
        return Component.translatable("chat.bannermod.workers.text.merchantLimitReachedOwner", this.getName().getString(), currency, goods);
    }

    public Component TEXT_LIMIT_REACHED(){
        return Component.translatable("chat.bannermod.workers.text.merchantLimitReached", this.getName().getString());
    }

    public Component TEXT_NOT_ENOUGH_ITEMS(String s){
        return Component.translatable("chat.bannermod.workers.text.merchantNotEnoughItems", this.getName().getString(), s);
    }

    public Component TEXT_CUSTOMER_NO_SPACE(){
        return Component.translatable("chat.bannermod.workers.text.merchantCustomerNoSpace", this.getName().getString());
    }

    public Component TEXT_NO_SPACE(){
        return Component.translatable("chat.bannermod.workers.text.merchantNoSpace", this.getName().getString());
    }

    public Component TEXT_NO_SPACE_OWNER(){
        return Component.translatable("chat.bannermod.workers.text.merchantNoSpaceOwner", this.getName().getString());
    }
}
