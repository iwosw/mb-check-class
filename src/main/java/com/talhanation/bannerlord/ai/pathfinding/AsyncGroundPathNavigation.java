...
public class AsyncGroundPathNavigation extends AsyncPathNavigation {
    ...
    public Path createPath(BlockPos p_26475_, int p_26476_) {
        return this.createPath(p_26475_, p_26476_, null);
    }

    protected Path createPath(BlockPos p_26475_, int p_26476_, @org.jetbrains.annotations.Nullable GlobalPathfindingController.FlowFieldPrototypeRequest flowFieldPrototypeRequest) {
        if (this.level.getBlockState(p_26475_).isAir()) {
            ...
            if (blockpos.getY() > this.level.getMinBuildHeight()) {
                return super.createPath(blockpos.above(), p_26476_, flowFieldPrototypeRequest);
            }
        ...
        if (!this.level.getBlockState(p_26475_).isSolid()) {
            return super.createPath(p_26475_, p_26476_, flowFieldPrototypeRequest);
        } else {
            BlockPos blockpos1;
            ...
            return super.createPath(blockpos1, p_26476_, flowFieldPrototypeRequest);
        }
    }
