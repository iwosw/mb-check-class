...
public class Corpse {
    ...
    public static void spawnCorpse(com.talhanation.bannerlord.entity.shared.AbstractInventoryEntity recruit) {
        CompoundTag nbt = new CompoundTag();
    ...
    public static void createCorpseFromDeath(com.talhanation.bannerlord.entity.shared.AbstractInventoryEntity recruit, Death death, CompoundTag deathCompound, ServerLevel level) throws ClassNotFoundException {
        try {
            Class<?> corpseClass = Class.forName("de.maxhenkel.corpse.entities.CorpseEntity");
