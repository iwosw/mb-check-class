...
public class CombatCategory implements ICommandCategory {
    private static final MutableComponent TOOLTIP_STRATEGIC_FIRE = Component.translatable("gui.bannermod.command.tooltip.strategic_fire");
    private static final MutableComponent TOOLTIP_HOLD_STRATEGIC_FIRE = Component.translatable("gui.bannermod.command.tooltip.hold_strategic_fire");
    private static final MutableComponent TOOLTIP_SHIELDS_UP = Component.translatable("gui.bannermod.command.tooltip.shields_up");
    private static final MutableComponent TOOLTIP_SHIELDS_DOWN = Component.translatable("gui.bannermod.command.tooltip.shields_down");
    private static final MutableComponent TOOLTIP_PASSIVE = Component.translatable("gui.bannermod.command.tooltip.passive");
    private static final MutableComponent TOOLTIP_NEUTRAL = Component.translatable("gui.bannermod.command.tooltip.neutral");
    private static final MutableComponent TOOLTIP_AGGRESSIVE = Component.translatable("gui.bannermod.command.tooltip.aggressive");
    private static final MutableComponent TOOLTIP_RAID = Component.translatable("gui.bannermod.command.tooltip.raid");
    private static final MutableComponent TOOLTIP_CLEAR_TARGET = Component.translatable("gui.bannermod.command.tooltip.clearTargets");
    private static final MutableComponent TOOLTIP_HOLD_FIRE = Component.translatable("gui.bannermod.command.tooltip.hold_fire");
    private static final MutableComponent TOOLTIP_FIRE_AT_WILL = Component.translatable("gui.bannermod.command.tooltip.fire_at_will");
    private static final MutableComponent TEXT_SHIELDS_UP = Component.translatable("gui.bannermod.command.text.shields_up");
    private static final MutableComponent TEXT_SHIELDS_DOWN = Component.translatable("gui.bannermod.command.text.shields_down");
    private static final MutableComponent TEXT_PASSIVE = Component.translatable("gui.bannermod.command.text.passive");
    private static final MutableComponent TEXT_NEUTRAL = Component.translatable("gui.bannermod.command.text.neutral");
    private static final MutableComponent TEXT_AGGRESSIVE = Component.translatable("gui.bannermod.command.text.aggressive");
    private static final MutableComponent TEXT_RAID = Component.translatable("gui.bannermod.command.text.raid");
    private static final MutableComponent TEXT_STRATEGIC_FIRE = Component.translatable("gui.bannermod.command.text.strategic_fire");
    private static final MutableComponent TEXT_HOLD_STRATEGIC_FIRE = Component.translatable("gui.bannermod.command.text.hold_strategic_fire");
    private static final MutableComponent TEXT_FIRE_AT_WILL = Component.translatable("gui.bannermod.command.text.fire_at_will");
    private static final MutableComponent TEXT_HOLD_FIRE = Component.translatable("gui.bannermod.command.text.hold_fire");
    private static final MutableComponent TEXT_CLEAR_TARGET = Component.translatable("gui.bannermod.command.text.clearTargets");
    private static final MutableComponent TOOLTIP_COMBAT = Component.translatable("gui.bannermod.command.tooltip.combat");

    private static final MutableComponent TEXT_ATTACK = Component.translatable("gui.bannermod.command.text.attack");
    private static final MutableComponent TOOLTIP_ATTACK = Component.translatable("gui.bannermod.command.tooltip.attack");
    @Override
